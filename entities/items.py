def createitems():
	...
	global hp, majhp, mindetector, majdetector, fleer
	...
	fleer = Item("Smoke Bomb", "fleer", "flee from your enemy", "You did not manage to flee from your enemy.", "15", "flee", "0.70", "1")